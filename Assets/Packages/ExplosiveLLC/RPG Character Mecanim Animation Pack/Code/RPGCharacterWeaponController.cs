...
namespace RPGCharacterAnims
{
    public class RPGCharacterWeaponController : MonoBehaviour
    {
        ...
        private void DoWeaponSwitch(int weaponSwitch, int weaponVisibility, int weaponNumber, int leftRight, bool sheath)
        {
            ...
            if (weaponSwitch < 1) { if (AnimationData.Is2HandedWeapon(weaponNumber)) { rpgCharacterController.Lock(true, true, true, 0f, 1f); } } 
			else if (AnimationData.Is1HandedWeapon(weaponSwitch)) { rpgCharacterController.Lock(true, true, true, 0f, 1f); }
        ...
        public IEnumerator _WeaponVisibility(int weaponNumber, bool visible, bool dual)
        {
            ...
            if (weaponNumber == 1) {
                ...
                SafeSetVisibility(twoHandSpear, visible);
            } else if (weaponNumber == 3) {
                SafeSetVisibility(twoHandAxe, visible);
            } else if (weaponNumber == 4) {
                SafeSetVisibility(twoHandBow, visible);
            } else if (weaponNumber == 5) {
                SafeSetVisibility(twoHandCrossbow, visible);
            } else if (weaponNumber == 6) {
                SafeSetVisibility(staff, visible);
            } else if (weaponNumber == 7) {
                SafeSetVisibility(shield, visible);
                ...
                SafeSetVisibility(rifle, visible);
            } else if (weaponNumber == 19) {
                SafeSetVisibility(spear, visible);
            }
            yield return null;
        }
