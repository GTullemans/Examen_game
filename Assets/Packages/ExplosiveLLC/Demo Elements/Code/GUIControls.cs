    ...
    public class GUIControls : MonoBehaviour
    {
        ...
        private void RollDodgeTurn()
        {
            if (rpgCharacterController.CanStartAction("Roll")) {
                ...
                if (GUI.Button(new Rect(445, 30, 100, 30), "Dive Roll")) { rpgCharacterController.StartAction("DiveRoll", 1); }
            }
        ...
        private void WeaponSwitching()
        {
            ...
            if (hipShooting) { rpgCharacterController.StartAction("HipShoot"); } 
			else { rpgCharacterController.EndAction("HipShoot"); }
        ...
        private void Emotes()
        {
            if (rpgCharacterController.CanStartAction("Emote")) {
                ...
                if (emote != "") {
                    rpgCharacterController.StartAction("Emote", emote);
                }
            }
            ...
            if (rpgCharacterController.CanStartAction("EmoteCombat")) {
                ...
                if (emote != "") {
                    rpgCharacterController.StartAction("EmoteCombat", emote);
                }
            }
        }
